...
Nesse desafio, você continuarei desenvolvendo a aplicação de gestão de transações, a GoFinances. Agora você praticarei o que aprendi até agora no React.js junto com TypeScript, utilizando rotas e envio de arquivos por formulário.

Essa será uma aplicação que irá se conectar ao seu backend do desafio 6
...
<img width="80%" src="./assets/GoFinance.png">
