...
Nesse desafio, estarei criando uma nova aplicação para treinar o que você aprendi até agora no Node.js junto ao TypeScript, incluindo o uso de banco de dados com o TypeORM, e relacionamentos ManyToMany!
