...
var AppointmentRespository = /** @class */ (function () {
    function AppointmentRespository() {
        this.ormRepository = typeorm_1.getRepository(Appointment_1.default);
    }
    AppointmentRespository.prototype.findByDate = function (date) {
    ...
    AppointmentRespository.prototype.findAllInMonthFromProvider = function (_a) {
    ...
    AppointmentRespository.prototype.findAllInDayFromProvider = function (_a) {
    ...
    AppointmentRespository.prototype.create = function (_a) {
